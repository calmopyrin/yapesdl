...
const instructions ins[256] =
						{ {"BRK", 1,7,0,0},   // 00 - BRK
						  ...
						  {"PHP", 1,3,0,9},   // 08
						  {"ORA", 2,2,0,2},   // 09 - ORA #$20
						  {"ASL", 1,2,0,2},   // 0A - ASL
						  {"ANC", 2,2,1,9},   //*0B - ANC #$20
						  ...
						  {"PLP", 1,4,0,9},   // 28 - PLP
						  {"AND", 2,2,0,2},   // 29 - AND #$20
						  {"ROL", 1,2,0,2},   // 2A - ROL
						  {"ANC", 2,2,1,9},   //*2B - ANC #$20
						  ...
						  {"PHA", 1,3,0,9},   // 48 - PHA
						  {"EOR", 2,2,0,2},   // 49 - EOR #$20
						  {"LSR", 1,2,0,2},   // 4A - LSR
						  {"ANL", 2,2,1,9},   //*4B - ANL #$20
						  ...
						  {"NOP",2,2,1,0},   //*80 - NOP #$00
						  {"STA",11,6,0,5},   // 81 - STA ($B0,X)
						  {"NOP",2,2,1,0},   //*82 - NOP ($B0,X)
						  ...
						  {"DEY", 1,2,0,4},   // 88 - DEY
						  {"NOP", 2,2,1,0},   //*89 - NOP #$20
						  {"TXA", 1,2,0,2},   // 8A - TXA
						  {"XAA", 2,2,1,9},   //*8B - TAN #$20
						  ...
						  {"LDY", 2,2,0,4},   // A0 - LDY #$20
						  {"LDA",11,6,0,2},   // A1 - LDA ($B0,X)
						  {"LDX", 2,2,0,3},   // A2 - LDX #$20
						  ...
						  {"TAY", 1,2,0,4},   // A8 - TAY
						  {"LDA", 2,2,0,2},   // A9 - LDA #$20
						  {"TAX", 1,2,0,3},   // AA - TAX
						  {"ANX", 2,2,1,9},   //*AB - ANX #$20
						  ...
						  {"INY", 1,2,0,4},   // C8 - INY
						  {"CMP", 2,2,0,9},   // C9 - CMP #$20
						  {"DEX", 1,2,0,3},   // CA - DEX
						  {"XAS", 2,2,1,9},   //*CB - XAS #$20
						  ...
						  {"INX", 1,2,0,3},   // E8 - INX
						  {"SBC", 2,2,0,2},   // E9 - SBC #$20
						  {"NOP", 1,2,0,0},   // EA - NOP
						  {"SBC", 2,2,1,2},   //*EB - SBC #$20
